...
We look at the relationship between sulphates and alcohol content for various qualities of wine. We see a slight negative trend 

```{r}
ggplot(data = wine, aes(x= alcohol, y= sulphates, color = as.factor(quality)))+
  geom_point()+
...
ggplot(data = wine, aes(x= sulphates.to.alcohol, y= qual.factors, color = quality))+
  ...
  ylab("Ciric acid to Volatile acidity")+
